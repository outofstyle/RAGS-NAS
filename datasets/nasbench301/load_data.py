...
class Dataset:
    ...
    def __init__(
        ...
        file = '/home/liugroup/VAE_NAS/AG-Net-main/datasets/NASBench301/normal_cell_topologies.json'
        ...
        if isinstance(item , list):
            ...
            for graph in item:
                ...
                try:
                    ...
                    # Predict
                    prediction_genotype = performance_model.predict(config=genotype, representation="genotype", with_noise=False)
