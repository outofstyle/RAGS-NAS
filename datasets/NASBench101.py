...
from datasets.nasbench import api
...
class Dataset:
    ...
    def __init__(
        ...
        if __name__ == "__main__":
            path = os.path.join('/home/liugroup/VAE_NAS/AG-Net-main/datasets/nasbench')
        else:
            path = os.path.join('/home/liugroup/VAE_NAS/AG-Net-main/datasets/nasbench') #for debugging
