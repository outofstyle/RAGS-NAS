...
from datasets.nasbench.lib import config
from datasets.nasbench.lib import evaluate
from datasets.nasbench.lib import model_metrics_pb2
from datasets.nasbench.lib import model_spec as _model_spec
import numpy as np
...
class NASBench(object):
  ...
  def evaluate(self, model_spec, model_dir):
    ...
    with tf.compat.v1.gfile.Open(metadata_file, 'w') as f:
