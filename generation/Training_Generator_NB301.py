...
runfolder = f"{runfolder}_{args.name}_{args.dataset}_test"
...
if args.dataset=='NB301':
    data_config_path='/home/liugroup/ranker/AG-Net-main/configs/data_configs/NB301_configspace.json'
else:
...
if args.dataset=='NB301':
    ...
    dataset = NASBench301.Dataset(batch_size=model_config['batch_size'], generation=False)
else:
    raise TypeError("Unknow Seach Space : {:}".format(args.dataset))
